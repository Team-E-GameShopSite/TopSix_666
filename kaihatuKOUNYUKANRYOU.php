...
<link href="styleKOUNYUKANRYOU.css" rel="stylesheet" type="text/css">
...
<body>
    <div class="header">
        ...
        <div class="cartcheck">
            <img src="img/shopping-cart-with-check-mark-icon-Graphics-1-580x386.jpg"   class="d-block w-100" alt="..."  weight="400" height="700">
        </div>

        <div class="thankyou">
         <h1>お買い上げ</h1>
         <h1>ありがとうございます</h1>
            <a href="kaihatuTOP.html"  class="TOPNIMODORU"><button class="btn btn-outline-primary btn-lg"   type="button">TOPに戻る→</button></a>
        </div>
