...
<body>
  ...
  <p class="fs-1">404  ERROR</p>
  <p class="fs-1">ページが見つかりません</p>
  <div class="d-grid gap-2">
  <a href="kaihatuTOP.html"  class="TOPNIMODORU"><button class="btn btn-outline-primary  me-2"   type="button">TOPに戻る→</button></a>
  </div>
