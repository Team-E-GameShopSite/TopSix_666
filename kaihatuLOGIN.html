...
<head>
    ...
    <script type="text/javascript">
        function registClick(){
            ...
            if(isSuccess==true){
                window.location.href='kaihatuTOP.html';
            }
        }
...
<body>
    ...
    <div id="maindiv" class="container">
        ...
        <div class="owasure">
          ...
          <div class="sinki">
            <a href="kaihatuTOUROKU.html"  class="TOPNIMODORU"><button class="btn btn-outline-dark  me-2 btn-lg"   type="button"> 新規会員登録</button></a>
          </div>
