  ...
  document.getElementById("touroku").onclick = function() {
    ...
    if (flag == 1) {
      ...
      if (regexp.test(name_huri) != true) {
        document.getElementById('name_huri_chk').style.display = "block";
        flag_chk = 1;
      } else {
        document.getElementById('name_huri_chk').style.display = "none";
      }
