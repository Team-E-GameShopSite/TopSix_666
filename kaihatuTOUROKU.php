  ...
  <div class="name">
    ...
    <div class="text">
      <div class="form-check">
        <input class="form-check-input" size="100" type="radio" name="flexRadioDefault" value="男" id="flexRadioDefault1">
        <p class="fs-3">男</p>
      </div>
      
      <div class="form-check">
        <input class="form-check-input" size="100" type="radio" name="flexRadioDefault" value="女"  id="flexRadioDefault2">
        <p class="fs-3">女</p>
      </div>
      <div class="form-check">
        <input class="form-check-input" size="100" type="radio" name="flexRadioDefault" value="答えたくない" id="flexRadioDefault1"  checked="checked">
